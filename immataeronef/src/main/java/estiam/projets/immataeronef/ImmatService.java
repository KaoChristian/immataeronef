...
public class ImmatService {
	...
	/**
	 *  Compte le nombre d'appareils pour chaque constructeur et retourne un Map avec le constructeur comme clé
	 *  et le nombre d'appareils comme valeur
	 * @return Map avec le constructeur comme clé et le nombre d'appareils comme valeur
	 */
